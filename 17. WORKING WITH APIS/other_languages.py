...
class GitRepos:
    ...
    def __init__(self):
        self.search_language = input("Enter Language: ")
        self.url = 'https://api.github.com/search/repositories'
        self.url += f'?q=language:{self.search_language}+sort:stars+stars:>10000'
        self.r = None
        self.repo_names = []
        self.stars = []
        self.hover_texts = []
    ...
    def make_visualization(self):
        title = f"Most-Starred {self.search_language} Projects on GitHub"
