...
class Weather:
    ...
    def __init__(self):
        self.file_path = 'weather_data/dhaka.csv'
    ...
    def extract_weather_data(self):
        ...
        for i in range(len(self.dates)):
            print(self.dates[i].strftime("%Y-%m-%d"), self.highs[i], self.lows[i], sep="\t")
    ...
    def plot_weather_data(self):
        ...
        ax.set_ylim(10, 140)  # Setting y-axis limits to match both Sitka and Death Valley
